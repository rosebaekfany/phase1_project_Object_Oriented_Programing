...
public class ChatBottom extends SwitchScenes implements Initializable {
    ...
    public void sendText(){
        ...
        if (!text.equals("")){
            if (Input.myRegister.chatOnBord.blockState.equals("blocked")){
                textField.setText("YOU ARE BLOCKED");
            } else {
                Communication.DMing(Input.myRegister.chatOnBord , Input.myRegister.allRegisters.get(Input.myRegister.logedInAccount) , text);
